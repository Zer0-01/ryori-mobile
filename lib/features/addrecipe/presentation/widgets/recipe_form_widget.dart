...
import 'package:ryori/features/addrecipe/presentation/widgets/add_recipe_button_widget.dart';
import 'package:ryori/features/addrecipe/presentation/widgets/media_picker_widget.dart';
...
import 'package:ryori/features/addrecipe/presentation/widgets/recipe_type_form_widget.dart';
...
class _RecipeFormWidgetState extends State<RecipeFormWidget> {
  ...
  Widget build(BuildContext context) {
    final hasSelectedMedia = context.watch<AddRecipeViewModel>().hasSelectedMedia;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              RecipeTypeFormWidget(controller: widget.typeController),
              ...
              Consumer<AddRecipeViewModel>(
                builder: (context, vm, child) {
                  return AddRecipeButtonWidget(
                    isLoading: vm.postRecipeStatus == PostRecipeStatus.loading,
  ...
  void _submit(BuildContext context) {
    ...
    final hasMedia = context.read<AddRecipeViewModel>().hasSelectedMedia;
    ...
    context.read<AddRecipeViewModel>().saveRecipe(
